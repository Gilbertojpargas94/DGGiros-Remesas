...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { account: @quotation.account, amount: @quotation.amount, bank: @quotation.bank, country: @quotation.country, order: @quotation.order, rate: @quotation.rate, status: @quotation.status, user_id: @quotation.user_id } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { account: @quotation.account, amount: @quotation.amount, bank: @quotation.bank, country: @quotation.country, order: @quotation.order, rate: @quotation.rate, status: @quotation.status, user_id: @quotation.user_id } }
