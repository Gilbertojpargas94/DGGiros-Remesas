...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { headline: @bank.headline, name: @bank.name, status: @bank.status } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { headline: @bank.headline, name: @bank.name, status: @bank.status } }
